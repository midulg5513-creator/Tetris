...
class Theme:
    ...
    ambient_grid: AlphaColor = (120, 226, 255, 14)
    ...
    glass_fill: AlphaColor = (15, 29, 52, 188)
    glass_fill_strong: AlphaColor = (18, 34, 60, 214)
    glass_edge: AlphaColor = (104, 245, 255, 176)
    glass_edge_soft: AlphaColor = (255, 255, 255, 54)
